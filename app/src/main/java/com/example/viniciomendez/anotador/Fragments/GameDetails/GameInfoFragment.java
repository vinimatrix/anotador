...
import com.example.viniciomendez.anotador.GameDayActivity;
...
public class GameInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       Button btnAnotacion = (Button)view.findViewById(R.id.btn_anotacion);
       btnAnotacion.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View view) {
               Intent intent = new Intent(getActivity().getBaseContext(),GameDayActivity.class);
